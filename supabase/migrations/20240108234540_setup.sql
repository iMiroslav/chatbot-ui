...
AS $$
DECLARE
  project_url TEXT := 'https://spnhugybjgstresshttb.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNwbmh1Z3liamdzdHJlc3NodHRiIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyNjEzNzgxNywiZXhwIjoyMDQxNzEzODE3fQ.j_EHPauwPifRH_6JIGvH3G57iMHMJ7tca4IP9lg28FE'; -- full access needed for http request to storage
